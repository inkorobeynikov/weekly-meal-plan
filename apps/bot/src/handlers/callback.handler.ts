...
// The plan window starts TOMORROW (Europe/Warsaw) and runs for exactly one week
// (7 days). The user shops today, so today's dinner is not planned; the first
// cooked dinner is tomorrow's.
const PLAN_DAYS = 7
